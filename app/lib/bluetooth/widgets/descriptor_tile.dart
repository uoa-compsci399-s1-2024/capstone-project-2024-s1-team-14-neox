...
class _DescriptorTileState extends State<DescriptorTile> {
  ...
  Future onReadPressed() async {
    try {
      await d.read();
      SnackbarBluetooth.show(ABC.c, "Descriptor Read : Success", success: true);
    } catch (e) {
      SnackbarBluetooth.show(ABC.c, prettyException("Descriptor Read Error:", e), success: false);
    }
  }
  ...
  Future onWritePressed() async {
    try {
      ...
      SnackbarBluetooth.show(ABC.c, "Descriptor Write : Success", success: true);
    } catch (e) {
      SnackbarBluetooth.show(ABC.c, prettyException("Descriptor Write Error:", e), success: false);
    }
  }
